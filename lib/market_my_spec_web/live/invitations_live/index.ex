defmodule MarketMySpecWeb.InvitationsLive.Index do
  @moduledoc """
  LiveView for listing and managing pending invitations for a given account.

  Owners and admins can send new invitations, view all pending invitations,
  and cancel outstanding ones. Members without management rights see the
  invitation list but cannot send or cancel invitations.
  """
  ...
  @spec can_manage_members?(MarketMySpec.Users.Scope.t(), MarketMySpec.Accounts.Account.t()) ::
          boolean()
