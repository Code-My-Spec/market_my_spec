defmodule MarketMySpecWeb.UserLive.Login do
      ...
      <div class="mx-auto max-w-sm space-y-4">
        ...
        <div :if={local_mail_adapter?()} class="alert alert-info">
          ...
          <div>
            ...
            <p>
              To see sent emails, visit <.link href="/dev/mailbox" class="link">the mailbox page</.link>.
            </p>
          </div>
        </div>
  ...
  defp local_mail_adapter? do
    Application.get_env(:market_my_spec, MarketMySpec.Mailer)[:adapter] == Swoosh.Adapters.Local
  end
end
