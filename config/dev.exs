...
config :market_my_spec, MarketMySpecWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "lIokNJIY5cE4NpgHNiAwP219cLqNFz99cPxDkPhg2KMj1SIyZk1cmcHEo4h52Jld",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:market_my_spec, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:market_my_spec, ~w(--watch)]}
  ]
...
config :market_my_spec, MarketMySpecWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/market_my_spec_web/router\.ex$"E,
      ~r"lib/market_my_spec_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :market_my_spec, dev_routes: true
